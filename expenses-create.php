...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if (!in_array(true, array_column($upload_results, 'error'))) {
        ...
        $stmt = $conn->prepare("INSERT INTO `expenses` (`CampaignID`, `Description`, `Amount`, `ExpenseDate`) VALUES (?, ?, ?, ?)");

        try {
            $stmt->execute([ $CampaignID, $Description, $Amount, $ExpenseDate ]);
        } catch (Exception $e) {
        ...
        if (!isset($error)){
            ...
            header("location: expenses-read.php?ExpenseID=$new_id");
        } else {
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <a href="expenses-index.php" class="btn btn-secondary"><?php translate('Cancel') ?></a>
                    </form>
