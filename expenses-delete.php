...
if(isset($_POST["ExpenseID"]) && !empty($_POST["ExpenseID"])){
    ...
    $fileColumns = [];
    if (isset($tables_and_columns_names['expenses']['columns'])) {
        foreach ($tables_and_columns_names['expenses']['columns'] as $columnName => $columnDetails) {
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) . "?ExpenseID=" . $_GET["ExpenseID"]; ?>" method="post">
                    <?php print_error_if_exists(@$error); ?>
                        <div class="alert alert-danger fade-in">
                            <input type="hidden" name="ExpenseID" value="<?php echo trim($_GET["ExpenseID"]); ?>"/>
