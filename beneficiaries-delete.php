...
if(isset($_POST["BeneficiaryID"]) && !empty($_POST["BeneficiaryID"])){
    ...
    $fileColumns = [];
    if (isset($tables_and_columns_names['beneficiaries']['columns'])) {
        foreach ($tables_and_columns_names['beneficiaries']['columns'] as $columnName => $columnDetails) {
    ...
    $sql = "DELETE FROM `beneficiaries` WHERE `BeneficiaryID` = ?";
